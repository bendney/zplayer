...
#define MCU_PLUGIN_DIR "/opt/sophomcu-cn/lib/ptlib"
...
#define SYS_BIN_DIR "/opt/sophomcu-cn/bin"
// specify the path for .conf files
#define SYS_CONFIG_DIR "/opt/sophomcu-cn/config"
// specify the path for audio&video export via named pipes (linux, freebsd)
#define SYS_PIPE_DIR "/opt/sophomcu-cn/pipe"
// specify the path for built-in web server resources
#define SYS_RESOURCE_DIR "/opt/sophomcu-cn/resource"
// specify server logs folder
#define SERVER_LOGS "/opt/sophomcu-cn/log"
// specify true font directory
#define TRUETYPE_FONT_DIR "/opt/sophomcu-cn/font"
// specify records directory
#define RECORDS_DIR "/opt/sophomcu-cn/records"
// specify certificates directory
#define SYS_SSL_DIR "/opt/sophomcu-cn/ssl"
